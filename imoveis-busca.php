...
//verifica se foi postado uma pesquisa de produto
	if(isset($_POST['pesquisar'])){
		...
		$result_busca_home = "SELECT * FROM produtos WHERE nome LIKE '%".$pesquisar."%' LIMIT 100";
        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Imóveis Pesquisados</h1>
    ...
    <section class="property-grid grid">
      <div class="container">
        <div class="row">
		  ...
		  <?php while($row_imoveis = mysqli_fetch_assoc($resultado_busca_home)){?>
          <div class="col-md-4">
