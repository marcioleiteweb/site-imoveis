<?php
	...
	$result_produtos = "SELECT * FROM servico_geral WHERE id = '$id' LIMIT 1";
...
<div class="container theme-showcase" role="main">
	...
	<div class="page-header">
        <h1>Editar Serviços Geral</h1>
	</div>
	<div class="row">
		<div class="pull-right" style="padding-bottom: 20px; ">	
			<a href="administrativo.php?link=88" class="btn btn-sm btn-success">
				Voltar
			</a>
		</div>
	</div>
	<form class="form-horizontal" id="adm_cad_central" method="POST" action="administrativo/processa/edita/adm_proc_edita_servico_geral.php" enctype="multipart/form-data">
