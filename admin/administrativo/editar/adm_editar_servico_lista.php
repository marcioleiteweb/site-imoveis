<?php
	...
	$result_produtos = "SELECT * FROM servico_lista WHERE id = '$id' LIMIT 1";
...
<div class="container theme-showcase" role="main">
	...
	<form class="form-horizontal" id="adm_cad_central" method="POST" action="administrativo/processa/edita/adm_proc_edita_servico_lista.php" enctype="multipart/form-data">
