...
<div class="container theme-showcase" role="main">
	...
	<form class="form-horizontal" id="adm_cad_central" method="POST" action="administrativo/processa/edita/adm_proc_edita_estado_na_home.php" enctype="multipart/form-data">
