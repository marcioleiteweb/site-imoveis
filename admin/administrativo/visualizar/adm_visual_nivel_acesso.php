...
<div class="container theme-showcase" role="main">
	...
	<div class="row">
		<div class="pull-right" style="padding-bottom: 20px; ">
			...
			<!--
			<a href="administrativo/processa/apaga/adm_apagar_nivel_acesso.php?id=<?php echo $row_niveis_acessos["id"]; ?>">
	...
	<dl class="dl-horizontal">	
		...
		<dd>
		<?php 
		if($row_niveis_acessos['visualizar'] == "1"){
			echo '
		...
		<dd>
		<?php 
		if($row_niveis_acessos['gravar'] == "1"){
			echo '
			<div class="alert alert-success" role="alert">
			pode gravar
			</div>
		...
		<dd>
		<?php 
		if($row_niveis_acessos['deletar'] == "1"){
			echo '
			<div class="alert alert-success" role="alert">
			pode deletar
			</div>
