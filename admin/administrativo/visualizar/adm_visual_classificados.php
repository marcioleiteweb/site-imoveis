...
<div class="container theme-showcase" role="main">
	...
	<dl class="dl-horizontal">		
		...
		<dd class="alert alert-warning">	
			<form id="adm_cad_produto" class="form-horizontal" method="POST" action="administrativo/processa/cadastra/adm_proc_classificados_album.php" enctype="multipart/form-data">
