<?php
	...
	$result_produtos = "SELECT * FROM ads_home_topo WHERE id = '$id' LIMIT 1";
...
<div class="container theme-showcase" role="main">
	<div class="page-header">
        <h1>Visualizar ADS Home Topo</h1>
	</div>
	<div class="row">
		<div class="pull-right" style="padding-bottom: 20px; ">
			<a href="administrativo.php?link=40">
	...
	<dl class="dl-horizontal">		
		...
		<dt>Foto: </dt>
		<dd>
		<img src="<?php echo '../imgs-sistema/img-ads/ads-topo/'.$row_produtos['foto']; ?>" width="200">
		</dd>
	</dl>
</div>