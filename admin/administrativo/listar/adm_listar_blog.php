<?php
	$result_produtos = "SELECT * FROM blog_estados";
...
<div class="container theme-showcase" role="main">
	...
	<div class="row espaco">
		<div class="pull-right">
			<a href="administrativo.php?link=25"><button type='button' class='btn btn-sm btn-success'>Cadastrar</button></a>
		</div>
	</div>
	<div class="row">
        <div class="col-md-12">
			<table class="table">
				<thead>
					<tr>
						...
						<th class="text-center">Qual Estado</th>
					...
					<?php while($row_produtos = mysqli_fetch_assoc($resultado_produtos)){?>
						<tr>
							...
							<td class="text-center">
								<?php $categorias_produto = $row_produtos["id_estados"]; 
									$result_categorias_produto = "SELECT * FROM estados WHERE id = '$categorias_produto' LIMIT 1";
							...
							<td class="text-center">
								<a href="administrativo.php?link=24&id=<?php echo $row_produtos["id"]; ?>">
