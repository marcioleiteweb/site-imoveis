<?php
	...
	$cliente_id = mysqli_real_escape_string($conn, $_POST['cliente_id']);
	...
	$metros = mysqli_real_escape_string($conn, $_POST['metros']);
		...
		//	id	nome	material_id	cliente_id	descricao	status	local	metros	foto_principal	
		...
		//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta arquivo
			...
			if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'].$nome_final)){
				...
				$result_produtos = "INSERT INTO obras (nome, material_id, cliente_id, descricao, status, local,	metros,	foto_principal) VALUES ('$nome', '$material_id', '$cliente_id', '$descricao', '$status', '$local', '$metros', '$nome_final')";
