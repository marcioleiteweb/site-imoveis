<?php
	...
	$contato_ads_home_topo = mysqli_real_escape_string($conn, $_POST['contato_ads_home_topo']);

	

						
		//Pasta onde o arquivo vai se salvo
		$_UP['pasta'] = '../../../../imgs-sistema/img-ads/ads-topo/';
		...
		if(array_search($extensao, $_UP['extensoes']) === false){	
			 echo "
				<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=../../../administrativo.php?link=40'>
		...
		//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta arquivo
			...
			if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'].$nome_final)){
				...
				$result_produtos = "INSERT INTO ads_home_topo (link, foto) VALUES ('$contato_ads_home_topo','$nome_final')";
