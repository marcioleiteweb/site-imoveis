...
<html lang="pt-br">
	...
	<body> 
		...
		$nome_loja = mysqli_real_escape_string($conn, $_POST['nome_loja']);
		$whatsapp_loja = mysqli_real_escape_string($conn, $_POST['whatsapp_loja']);
		$mapa_loja = mysqli_real_escape_string($conn, $_POST['mapa_loja']);
	
						
		//Pasta onde o arquivo vai se salvo
		$_UP['pasta'] = '../../../../imagem_geral/lojas/';
		...
		if(array_search($extensao, $_UP['extensoes']) === false){	
			 echo "
				<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=../../../administrativo.php?link=32'>
		...
		//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta arquivo
			...
			if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'].$nome_final)){
				...
				$result_produtos = "INSERT INTO lojas (nome_loja, whatsapp_loja, mapa_loja, foto_loja) VALUES ('$nome_loja', '$whatsapp_loja', '$mapa_loja', '$nome_final')";
