<?php
	...
	$classificados_album = mysqli_real_escape_string($conn, $_POST['classificados_album']);
	
	
	//cria a pasta onde serão colocados os arquivos
		//Pasta onde o arquivo vai se salvo
		$_UP['pasta'] = '../../../../imgs-sistema/img-classificados/'.$classificados_album.'/';
		...
		//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta arquivo
			...
			if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'].$nome_final)){
				...
				$result_produtos = "INSERT INTO fotos_classificados (id_classificados, foto) VALUES ('$id_blog_classificados', '$nome_final')";
