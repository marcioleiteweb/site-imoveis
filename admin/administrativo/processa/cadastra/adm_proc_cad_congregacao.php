	...
	<body> 
		...
		//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta arquivo
			...
			if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'].$nome_final)){
				...
				$result_produtos = "INSERT INTO congregacoes (igreja, pastor, fotopastor, horarios, endereco) VALUES ('$igreja', '$pastor', '$nome_final', '$horarios', '$endereco')";
				...
				if(mysqli_affected_rows($conn) != 0){
			  	...
			  	echo "
					<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=../../../administrativo.php?link=12'>
					<script type=\"text/javascript\">
						alert(\"Congregação foi cadastrado com sucesso!.\");
					</script>
				"; 
				}else{
					//echo"nao foi";
				 	echo "
						<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=../../../administrativo.php?link=12'>
						<script type=\"text/javascript\">
							alert(\"Congregação não foi cadastrado!.\");
						</script>
					";
				}
			}else{
				//Upload não foi efetuado com sucesso
				 echo "
					<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=../../../administrativo.php?link=12'>
					<script type=\"text/javascript\">
						alert(\"O banner não foi cadastrado.\");
					</script>
				"; 
			}
		}?>
