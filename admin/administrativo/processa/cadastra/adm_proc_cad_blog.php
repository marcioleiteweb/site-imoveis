<?php
	...
	//cria a pasta onde serão colocados os arquivos
		mkdir("../../../../imgs-sistema/img-estados/$blog_album") or die("erro ao criar diretório");
		...
		//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta arquivo
			...
			if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'].$nome_final)){
				...
				$result_produtos = "INSERT INTO blog_estados (id_estados, titulo, texto, foto_principal, blog_album) VALUES ('$id_estados', '$titulo_blog', '$texto_blog', '$nome_final', '$blog_album')";
