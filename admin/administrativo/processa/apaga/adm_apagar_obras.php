<?php
	...
	$pasta_caminho = '../../../../imgs-sistema/img-obras/'.$exibe_produto['foto_principal'];
	$pasta_caminho_todas_fotos = '../../../../imgs-sistema/img-obras/'.$exibe_produto['obras_album'].'/';
...
<html lang="pt-br">
	...
	<body> <?php
		if($exibe_produto != 0){
			...
			$result_produtos = "DELETE FROM obras WHERE id = '$id'";
			$resultado_apagar = mysqli_query($conn, $result_produtos);
			
			//deleta a linha do banco das fotos
			$result_blog_album = "DELETE FROM   fotos_obras WHERE id_obras = '$id'";
