<?php
	...
	$select_produto = "SELECT * FROM  ads_home WHERE id = '$id'";
	$resultado_produto = mysqli_query($conn, $select_produto);
	$exibe_produto = mysqli_fetch_assoc($resultado_produto);
	
	$pasta_caminho = '../../../../imgs-sistema/img-ads/ads-home/'.$exibe_produto['foto'];
...
<html lang="pt-br">
	...
	<body> <?php
		if($exibe_produto != 0){
			...
			$result_produtos = "DELETE FROM ads_home WHERE id = '$id'";
