<?php
	...
	//echo "id do produto". $id."<br><br>";
		...
		$result_usuario = "UPDATE classificados SET titulo ='$titulo_classificado', texto='$texto_classificado', foto_principal='$caminho_produto', classificado_album = '$classificado_album', contato_bt = '$contato_classificado' WHERE id = '$id'";
		...
		//exit;
				...
				$result_usuario = "UPDATE classificados SET titulo ='$titulo_classificado', texto='$texto_classificado', foto_principal='$nome_final', classificado_album ='$classificado_album', contato_bt='$contato_classificado' WHERE id = '$id'";
			$resultado_usuario = mysqli_query($conn, $result_usuario);
