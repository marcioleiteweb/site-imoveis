<?php
	...
	//echo "id do produto". $id."<br><br>";
		...
		$_UP['pasta'] = '../../../../imgs-sistema/img-obras/';
		...
		$select_produto = "SELECT * FROM obras WHERE id = '$id'";
		...
		$classificado_album = $exibe_produto['obras_album'];
		//echo "$caminho_produto";
	
		//exit;
		
		$result_usuario = "UPDATE obras SET titulo ='$titulo', texto='$texto', foto_principal='$caminho_produto', obras_album ='$classificado_album' WHERE id = '$id'";
		$resultado_usuario = mysqli_query($conn, $result_usuario);
		echo "
	
				<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=../../../administrativo.php?link=48'>
		...
		//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta foto
			...
			$caminho_pasta2 = '../../../../imgs-sistema/img-obras/'.$exibe_produto['foto_principal'];
		...
		$classificado_album = $exibe_produto['obras_album'];
				...
				$result_usuario = "UPDATE obras SET titulo ='$titulo', texto='$texto', foto_principal='$nome_final', obras_album ='$classificado_album' WHERE id = '$id'";
			$resultado_usuario = mysqli_query($conn, $result_usuario);
