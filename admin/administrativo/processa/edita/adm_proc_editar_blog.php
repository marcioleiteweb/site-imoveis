<?php
	...
	$titulo_blog = mysqli_real_escape_string($conn, $_POST['titulo_blog']);
	$texto_blog = mysqli_real_escape_string($conn, $_POST['texto_blog']);
	$id_estados = mysqli_real_escape_string($conn, $_POST['id_estados']);
	
	//echo "id do produto". $id."<br><br>";
	
		 //Pasta onde o arquivo vai se salvo
		$_UP['pasta'] = '../../../../imgs-sistema/img-estados/';
		...
		$result_usuario = "UPDATE blog_estados SET 	id_estados ='$id_estados', titulo='$titulo_blog', texto='$texto_blog', foto_principal='$caminho_produto' WHERE id = '$id'";
		...
		//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta foto
			...
			$caminho_pasta2 = '../../../../imgs-sistema/img-estados/'.$exibe_produto['foto_principal'];
		...
		if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'].$nome_final)){
				$result_usuario = "UPDATE blog_estados SET id_estados ='$id_estados', titulo='$titulo_blog', texto='$texto_blog', foto_principal = '$nome_final' WHERE id = '$id'";
			$resultado_usuario = mysqli_query($conn, $result_usuario);
