<?php
	...
	//echo "id do produto". $id."<br><br>";
		...
		$_UP['pasta'] = '../../../imgs-sistema/parcerias/';
		...
		$select_produto = "SELECT * FROM parcerias WHERE id = '$id'";
		...
		$result_usuario = "UPDATE parcerias SET titulo='$titulo', foto='$caminho_produto', link='$link' WHERE id = '$id'";
		$resultado_usuario = mysqli_query($conn, $result_usuario);
		}
		echo "
			
				<META HTTP-EQUIV=REFRESH CONTENT = '0;URL=../../../administrativo.php?link=98'>
		...
		//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta foto
			...
			$caminho_pasta2 = '../../../imgs-sistema/parcerias/'.$exibe_produto['foto'];
		...
		if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'].$nome_final)){
			$result_usuario = "UPDATE parcerias SET titulo='$titulo', foto='$nome_final', link = '$link' WHERE id = '$id'";
			$resultado_usuario = mysqli_query($conn, $result_usuario);
