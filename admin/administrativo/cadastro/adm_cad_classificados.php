<div class="container theme-showcase" role="main">
	...
	<form id="adm_cad_produto" class="form-horizontal" method="POST" action="administrativo/processa/cadastra/adm_proc_cad_classificado.php" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea name="texto_classificado" class="form-control"  rows="10" id="mytextarea1" placeholder="Texto" required></textarea>
			</div>
		</div>
		<div class="form-group">
			<label class="col-sm-2 control-label">Local</label>
			<div class="col-sm-10">
				<input type="text" name="contato_classificado" required class="form-control" id="inputEmail3" placeholder="Local da Obra">
			</div>
		</div>
