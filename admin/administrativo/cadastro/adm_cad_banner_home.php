<div class="container theme-showcase" role="main">
	...
	<div class="row">
		<div class="pull-right" style="padding-bottom: 20px; ">
			<a href="administrativo.php?link=20"><button type='button' class='btn btn-sm btn-success'>voltar</button></a>
		</div>
	</div>
	<form class="form-horizontal" id="adm_cad_banner" method="POST" action="administrativo/processa/cadastra/adm_proc_cad_banner_home.php" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
				<textarea name="texto" class="form-control" maxlength="1000" rows="5" id="inputEmail3" placeholder="texto" required></textarea>
			</div>
		</div>
		...
		<div class="form-group">
			<label for="inputEmail3" class="col-sm-2 control-label">logo do banner</label>
			<div class="col-sm-10">
