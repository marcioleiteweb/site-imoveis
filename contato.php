        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Contato</h1>
              ...
              <div class="col-md-5 section-md-t3">
                <div class="icon-box section-b2">
                  ...
                  <div class="icon-box-content table-cell">
                    ...
                    <div class="icon-box-content">
                      <p class="mb-1">Email.
                        <span class="color-a">contato@suaempresa.com.br</span>
                      </p>
                      <p class="mb-1">Telefone.
                        <span class="color-a">(31) 3355-8877</span>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="icon-box section-b2">
                  ...
                  <div class="icon-box-content table-cell">
                    ...
                    <div class="icon-box-content">
                      <p class="mb-1">
                        Rua Monteira de Souza, 36 - Jd.Motuba
                        <br> Monte Belo - MG
                      </p>
                    </div>
                  </div>
